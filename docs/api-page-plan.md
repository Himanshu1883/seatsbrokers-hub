...
4. **ApiProductBoard** — the seven existing products (Events, Inventory, Listing, Order, Pricing, Delivery, Partner) as photo cards (`.apc-*`); same card copy as before. `ApiCards` unmounted.
