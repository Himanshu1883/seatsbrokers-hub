...
const stages: Stage[] = [
  ...
  },
  {
    ...
    body: "Request tickets that are not listed on SeatsBrokers. Our global network returns competitive B2B options for hard-to-find, premium and hospitality inventory.",
    metric: "On demand",
    metricLabel: "sourcing desk",
    lines: ["request.open → live", "network.search → active", "options.ready → quote"],
    icon: RefreshCw,
  },
  {
    id: "platform",
