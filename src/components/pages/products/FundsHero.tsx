...
import { fundsHeroCopy } from "@/content/funds-hero-data";
import { ctas } from "@/content/site";
import { FundsConsoleWall } from "./FundsConsoleWall";

function FundsHeroIcon({ className }: { className?: string }) {
  return (
      ...
      <div className="container-page relative z-10">
        <div className="bh-layout">
          <Reveal className="bh-copy">
            <FundsHeroIcon className="bh-copy-icon" />
            <p className="section-eyebrow text-primary">{fundsHeroCopy.eyebrow}</p>
            <h1 className="bh-title">{fundsHeroCopy.title}</h1>
            <p className="bh-subhead">{fundsHeroCopy.subhead}</p>
            <p className="bh-body">{fundsHeroCopy.body}</p>
            <ul className="bh-points">
              <li>Purchasing, balances and payment methods on the ticketing desk</li>
              <li>Eligible partner settlements follow the rules you set</li>
              <li>Standard is the default rail — USDT where it is eligible</li>
            </ul>
