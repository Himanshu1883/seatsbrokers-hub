...
export const productsWorkflowLayers = [
  ...
  },
  {
    ...
    line: "On-demand sourcing for inventory not already on the platform.",
  ...
  proofs: [
    {
      id: "workflow",
      title: "One workflow",
      body: "From opportunity to settlement.",
    },
    {
      id: "inventory",
      title: "One inventory layer",
      body: "Across all channels.",
    },
    {
      id: "scale",
      title: "Global scale",
      body: "More events. More opportunities.",
    },
  ],
} as const;
...
export const productCards = [
  {
    ...
    name: modules.intel.name,
    tagline: modules.intel.tagline,
    caption: "Opportunity before you source",
  ...
  },
  {
    ...
    name: modules.source.name,
    tagline: modules.source.tagline,
    caption: "On-demand sourcing desk",
    body: "SeatsSource™ is your broker sourcing desk. When tickets are not available on the SeatsBrokers platform, submit a request and our sourcing team works the global network for competitive B2B options — hard-to-find, premium and hospitality inventory included.",
    href: productHrefs.source,
  ...
  },
  {
    ...
    name: modules.pulse.name,
    tagline: modules.pulse.tagline,
    caption: "AI recommends. You decide.",
  ...
  },
  {
    ...
    name: modules.link.name,
    tagline: modules.link.tagline,
    caption: "Connect your ticketing operation",
  ...
  },
  {
    ...
    name: modules.market.name,
    tagline: modules.market.tagline,
    caption: "List once. Reach more buyers",
...
export const productsSteps = [
  ...
  `${modules.source.name} — request inventory not listed on the platform`,
...
export const productStories = {
  ...
  source: {
    what: "SeatsSource™ is your back-office sourcing department, built into SeatsBrokers. When inventory is not listed on the platform, brokers submit a request and our sourcing team works the global network for the best available options and competitive B2B pricing.",
    problem: {
      eyebrow: "The problem",
      title: "The tickets your customer needs are not always listed.",
      body: "Hard-to-find, premium and hospitality inventory often sits outside your live catalog. Without a dedicated sourcing desk, brokers chase networks by hand — or turn the enquiry away.",
      items: [
        { label: "Need", value: "Tickets not listed" },
        { label: "Today", value: "Manual chase" },
        { label: "Risk", value: "Lost enquiry" },
      ],
    },
    how: {
      eyebrow: "How SeatsBrokers solves it",
      title: "If it's not listed, request it.",
      steps: [
        "Request — submit the ticket requirement through SeatsBrokers",
        "Source — our team works the global sourcing network",
        "Compare — review competitive B2B options returned",
        "Quote — manage quotations from one place",
        "Buy — convert sourced inventory into an order",
      ],
    },
    capabilities: {
      eyebrow: "Capabilities",
      title: "Your sourcing desk, on demand",
      intro:
        "Extend the broker's sourcing capability without employing additional back-office sourcing staff.",
      items: [
        { id: "requests", title: "Ticket requests", body: "Submit ticket requests directly through SeatsBrokers when stock is not on the platform." },
        { id: "network", title: "Global sourcing network", body: "Access our dedicated network for inventory that is not currently listed." },
        { id: "hard-to-find", title: "Hard-to-find inventory", body: "Source seats that are scarce, sold out elsewhere or not in your live catalog." },
        { id: "hospitality", title: "Premium & hospitality", body: "Source premium and hospitality inventory alongside standard ticket requests." },
        { id: "compare", title: "Compare B2B options", body: "Receive competitive B2B options and compare available offers in one place." },
        { id: "convert", title: "Request to order", body: "Manage requests and quotations, then convert sourced inventory into an order." },
      ],
    },
    integration: {
      eyebrow: "Platform integration",
      title: `${modules.source.name} extends the desk when stock is missing`,
      body: "Sourcing sits beside intelligence, pricing and distribution — inventory already on the platform stays in the Core Engine; SeatsSource covers what is not listed.",
      chain: [
        { id: "intel", name: modules.intel.name, href: productHrefs.intel },
        { id: "source", name: modules.source.name, href: productHrefs.source },
        { id: "pulse", name: modules.pulse.name, href: productHrefs.pulse },
